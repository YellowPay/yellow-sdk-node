...
yellow.createInvoice = function(api_key, api_secret, base_ccy, base_price, callback_url, fn){
  /**
   ...
   */
   ...
   if (typeof callback_url === "function") {
    ...
    if(callback_url) payload.callback = callback_url;
...
yellow.verifyIPN = function(api_secret, host_url, request){
   ...
   */
   ...
   return signature === request_signature ? true : false;
}
